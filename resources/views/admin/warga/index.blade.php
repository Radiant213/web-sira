                                    ...
                                    @if(!$w->is_verified)
                                        ...
                                        <div x-data="{ showModal: false }">
                                            ...
                                            <div x-show="showModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0" style="display: none;">
                                                ...
                                                <div class="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl z-10 text-center text-wrap whitespace-normal">
                                                    ...
                                                    <div class="mt-6 flex justify-center gap-3">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.warga.reject', $w) }}">
                                                            @csrf @method('DELETE')
                                                            <button type="submit" class="rounded-xl px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700" style="cursor: pointer;">Ya, Tolak</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
