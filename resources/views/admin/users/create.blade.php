        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 sm:p-8">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <select name="role" class="block w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-3 text-sm transition-colors focus:border-primary-500 focus:bg-white focus:ring-primary-500" required>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="address" rows="3" 
                                  class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 focus:border-primary-500 focus:bg-white focus:ring-2 focus:ring-primary-500/20">{{ old('address') }}</textarea>
                ...
                <div class="pt-4 border-t border-slate-100">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div class="mb-6 col-span-2 md:col-span-1">
                            <label for="role" class="mb-2 block text-sm font-semibold text-slate-700">Role / Peran</label>
                            <div class="relative">
                                <select name="role" id="role" class="block w-full appearance-none rounded-xl border-slate-200 bg-slate-50 px-4 py-3 text-sm transition-colors focus:border-primary-500 focus:bg-white focus:ring-primary-500 @error('role') border-rose-500 focus:border-rose-500 focus:ring-rose-500 @enderror" required>
